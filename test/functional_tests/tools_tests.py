...
import contexts
from contexts.plugins.identifiers import DecoratorBasedIdentifier, NameBasedIdentifier
...
class WhenMarkingAClassAsASpec:
    ...
    def because_we_run_the_module(self):
        contexts.run(self.module, [DecoratorBasedIdentifier(), NameBasedIdentifier()])
